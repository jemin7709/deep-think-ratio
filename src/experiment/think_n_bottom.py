"""이미 생성된 run 산출물로 하위 prefix-DTR Think@n 실험을 재현한다."""
...
class DocResult:
    """문제 하나에 대한 하위 Think@n 선택 결과와 비용/성능을 담는다."""
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Replay a run with lower prefix DTR ranking and Think@n-style subset voting."
    )
